...
function fgmaxdata(outdir::AbstractString)
    ...
    for i = 1:num_fgmax_grids
        ...
        if point_style == 0
            ...
            ## instance
            fg[i] = VisClaw.FixedGrid(FGid, point_style, num_fgmax_val, NaN, NaN, 1, 1, npts, x, y)
        ...
        elseif point_style == 2
            ...
            x2, y2 = parse.(Float64, split(strip(txt[baseline+11]), r"\s+")[1:2])
            # instance
            fg[i] = VisClaw.FixedGrid(FGid, point_style, num_fgmax_val,  NaN, NaN, 1, 1, nx, ny, (x1,x2), (y1,y2))
            baseline += 12
        ...
        elseif point_style == 4
            ...
            ## instance
            fg[i] = VisClaw.FixedGrid(FGid, point_style, num_fgmax_val, NaN, NaN, 1, 1,
